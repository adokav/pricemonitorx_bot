...
## ✨ Özellikler
- **8 sinyalin konfluensi:** Trend (SMA50/200), Golden/Death Cross, RSI, MACD,
...
| `ALERT_SCORE_THRESHOLD` | ➖ | `0.35` | Yeni sinyal (giriş) eşiği |
| `SIGNAL_EXIT_THRESHOLD` | ➖ | `0.15` | Formasyon bozuldu (çıkış) eşiği — histerezis |
| `QUOTE_ASSET` | ➖ | `USDT` | İşlem çifti karşılığı |
| `SCAN_INTERVAL_MIN` | ➖ | `30` | Periyodik tarama sıklığı (dk) |
| `ALERT_SCORE_THRESHOLD` | ➖ | `0.35` | Alarm eşiği (0-1) |
